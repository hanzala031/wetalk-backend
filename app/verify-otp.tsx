...
// Custom SVG Illustration matching WeTalk branding (Envelope + Lock + Flying Paper Plane)
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        setOtpError(response.data?.message || 'Failed to resend OTP code.');
      }
    } catch (err: any) {
            ...
            <View style={styles.cardContainer}>
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  (cooldown > 0 || isResending) && styles.disabledButton,
                  { marginBottom: 16 }
                ]}
