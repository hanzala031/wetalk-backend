...
export const QuizStep = ({ content, onValidate }: QuizStepProps) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.instruction}>{content.instruction || 'Which of these is a greeting?'}</Text>
...
const styles = StyleSheet.create({
  ...
  optionText: { fontSize: 24, fontFamily: 'Nunito-SemiBold', color: '#475569' },
