...
const GOAL_OPTIONS: GoalOption[] = [
  { id: '1', time: '3 min / day', label: 'Casual' },
  { id: '2', time: '10 min / day', label: 'Regular' },
  { id: '3', time: '15 min / day', label: 'Serious' },
  { id: '4', time: '30 min / day', label: 'Intense' },
];
...
export const OnboardingGoalScreen = () => {
  ...
  const renderGoalItem = ({ item }: { item: GoalOption }) => {
    ...
    const labelKey = GOAL_KEYS[item.label] || item.label;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.bubbleContainer}>
           <View style={styles.bubble}>
              <Text style={styles.bubbleText}>{t('daily_goal')}</Text>
           </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity 
          ...
          disabled={!selectedId}
          onPress={() => {
            console.log('Selected Goal:', selectedId);
            // Navigate to achieve screen
            router.push({
              pathname: '/onboarding-achieve',
              params: { language: language || 'English' }
            });
          }}
        >
          <Text style={[styles.buttonText, !selectedId && styles.buttonTextDisabled]}>{t('committed')}</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
