...
export const OnboardingPlacementScreen = () => {
  ...
  const options = [
    {
      id: 'scratch',
      title: t('placement_1_title', { lang: language || 'English' }),
      subtitle: t('placement_1_desc'),
      icon: 'book',
      iconColor: '#FBBF24',
      recommended: true,
    },
    {
      id: 'test',
      title: t('placement_2_title', { lang: language || 'English' }),
      subtitle: t('placement_2_desc'),
      icon: 'compass',
      iconColor: '#EF4444',
      recommended: false,
    },
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.bubbleContainer}>
           <View style={styles.bubble}>
              <Text style={styles.bubbleText}>{t('placement_title')}</Text>
           </View>
            ...
            >
              {option.recommended && (
                <View style={styles.recommendedBadge}>
                  <Text style={styles.recommendedText}>{t('recommended').toUpperCase()}</Text>
                </View>
              )}
              ...
              <View style={styles.cardContent}>
                ...
                <View style={styles.textContainer}>
                  <Text style={[styles.title, isSelected && styles.selectedText]}>{option.title}</Text>
                  <Text style={[styles.subtitle, isSelected && styles.selectedText]}>{option.subtitle}</Text>
                </View>
              </View>
            </TouchableOpacity>
          );
